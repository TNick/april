...
/* ------------------------------------------------------------------------- */
/*!
  \file			apriltokenizer.h
  \date			Apr 2013
  \author		TNick
  
  \brief		Contains the definition for AprilTokenizer class
...
/* ------------------------------------------------------------------------- */
/* ========================================================================= */
#ifndef __AMODTOKENIZER_INC__
#define __AMODTOKENIZER_INC__
//
//
//
//
...
class
	APRILSHARED_EXPORT
	AprilTokenizer		: public MemTrack		{
	BBM_TRACK( AprilTokenizer );
