...
TEST(AprilTokenizer, empty_string) {
	
	initAprilLibrary();
	
	QString	s;
	AaTkString aas = AprilTokenizer::basicTk( s );
...
TEST(AprilTokenizer, one_letter) {
...
TEST(AprilTokenizer, one_letter_leading) {
...
TEST(AprilTokenizer, one_letter_trailing) {
...
TEST(AprilTokenizer, three_letters) {
...
TEST(AprilTokenizer, whites_and_letters) {
