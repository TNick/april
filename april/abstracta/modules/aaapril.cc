...
/* ------------------------------------------------------------------------- */
void			AaApril::insertCommands			( void )
{
	/// @cond internal
	
	//! register a command from this package 
#define addOneCmd(c)	\
	AbstractApril::addCommand( QObject::tr( "april." stringify(c) ), AaApril::c )
...
/* ------------------------------------------------------------------------- */
void			AaApril::removeCommands			( void )
{
	/// @cond internal
	
	//! unregister a command from this package @internal
#define remOneCmd(c)	\
	AbstractApril::remCommand( QObject::tr( "april." stringify(c) ), AaApril::c );
